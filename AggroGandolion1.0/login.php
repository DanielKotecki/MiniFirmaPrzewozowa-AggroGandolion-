...
<div class="container">
  ...
  <form id="loginForm" action="check.php" method="post">
    ...
    <div class="form-group">
      ...
      <input type="login" name="login" class="form-control" id="loginMail" placeholder="np. JanuszNosacz69" autofocus>
    </div>
    <div class="form-group">
      <label for="formGroupExampleInput2" class="loginPar">Hasło</label>
      <input type="password" name="pass" class="form-control" id="loginPassword" placeholder="*********">
    </div>
    <a href="#"><p id="forgotPassword">Nie pamiętam hasła</p></a>
    <center><input type="submit" name="zaloguj" id="loginButton" value="Zaloguj" /></center>
    <br>
