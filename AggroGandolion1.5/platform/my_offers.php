...
<div id="Top">
      ...
      <div id="zakladki">
        ...
        <div class="op">
        <h3 class="pasek">Oferty</h3>
      </div></a>
      <a href="./../dodawanie/dodaj.php">
        <div class="op">
          <h3 class="pasek">Dodaj ofertę</h3>
        </div></a>
        <a href="./wyswietlanie.php">
        <div class="op" style="background:orange;">
        <h3 class="pasek">Moje oferty</h3>
        </div></a>
...
$user = $_SESSION['login'];
  ...
  $rezultat=mysqli_query($mysqli,"SELECT* From  completed where id='$user' order by id");
   ...
   echo '<div class="oferta">';
    ...
    echo '<div id="DaneR1">';
     ...
     echo '<h3 class="dane">'.'Adr(opcjonalny): '.$of['addr'].'</h3>';
      ...
      echo '<a href="wyslij.php?id='. $of['id'] .'">';
